...
export const homeSlides: HomeSlide[] = [
  {
    ...
    secondaryCta: { label: 'Ver Produto', href: '/keymod/' },
  ...
  },
  {
    ...
    secondaryCta: { label: 'Ver Produto', href: '/kvmgo/' },
  ...
  },
  {
    ...
    secondaryCta: { label: 'Ver Produto', href: '/minikvm/' },
  ...
  },
  {
    ...
    secondaryCta: { label: 'Ver Acessórios', href: '/accessories/' },

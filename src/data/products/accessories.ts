...
export const accessorySkus: AccessorySku[] = [
  {
    ...
    description: "Acessórios essenciais incluindo adaptadores de vídeo, cabos de alta velocidade e soluções de armazenamento. Melhore sua experiência Openterface com equipamentos de qualidade da TxA Shop.",
...
export const accessoriesProduct: Product = {
  ...
  seoDescription:
    "Acessórios Openterface — cabos, adaptadores, bolsas de ferramentas e conectores de vídeo.",
  ...
  painPoints: [
    "A falta do cabo certo no campo atrasa cada reparo",
  ],
  solutions: [
    "Acessórios selecionados e testados com produtos Openterface",
  ],
  hwFeatures: [
  ...
  useCases: [
    "Organização de kit de campo",
    "Conversão de formato de vídeo",
    "Cabos de reserva para mochilas de TI",
  ],
  useCaseCards: [
    {
